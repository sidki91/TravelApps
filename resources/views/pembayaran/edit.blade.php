...
<div class="form-sample">
  <input type="hidden" id="nomor_pembayaran" value="{{$row->no_pembayaran}}">
    ...
    <div class="col-md-4">
      <div class="form-group row" style="margin-top:-10px">
        ...
        <div class="col-sm-7">
          ...
          <input class="form-control" type="text" id="tgl_pembayaran" value="{{date('m/d/Y',strtotime($row->tgl_bayar))}}">
    ...
    <div class="col-md-4">
      <div class="form-group row" style="margin-top:-10px">
        ...
        <div class="col-sm-7">
          ...
          <input class="form-control" type="text" id="nomor_pesanan" value="{{$row->nomor_pesanan}}">
          <div class="input-group-append">
          <span class="input-group-text bg-transparent">
