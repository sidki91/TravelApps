...
function list_data_kota()
{
  ...
  $.ajax({
          type: "POST",
           url: 'pembayaran/list_data_pemesanan',
           data: {
...
<div class="form-group">
    ...
    <div class="col-sm-9">
      ...
      <input class="form-control" type="text" id="search_text" placeholder="isi dengan nomor pemesanan" onkeypress="search_enter(event)">
