...
<p></p>
						<div class="form-inline">
						  <div class="form-group">
						   <div class="col-md-10">
              <input type="text" class="form-control" id="description_search" placeholder="Enter nama pekerjaan" onkeypress="search_enter(event)" style="width:450px">
						  </div>
            </div>
          ...
          <div class="modal-body">
            ...
            <form class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="description" name="description" placeholder="isi dengan nama pekerjaan">
