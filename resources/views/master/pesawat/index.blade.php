...
<p></p>
						<div class="form-inline">
						  <div class="form-group">
						   <div class="col-md-10">
              <input type="text" class="form-control" id="description_search" placeholder="Enter nama pesawat" onkeypress="search_enter(event)" style="width:450px">
						  </div>
            </div>
  ...
  $('.modal-footer').on('click', '.add', function() {
    ...
    else
    {
      ...
      $.ajax({
          ...
          data: {
              '_token'        : $('input[name=_token]').val(),
              'kode_airlines' : $("#kode_airlines").val(),
          ...
          success: function(data) {
            ...
            {
                if (data.errors.kode_airlines)
                {
                      alertMsg(data.errors.kode_airlines,'error');
                }
                if (data.errors.nama_pesawat)
                {
                      alertMsg(data.errors.nama_pesawat,'error');
                }
