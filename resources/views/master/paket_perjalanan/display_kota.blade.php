...
function list_data_kota()
{
  ...
  $.ajax({
          type: "POST",
           url: 'paket_perjalanan/list_data_kota',
           data: {
...
<div class="form-group">
    ...
    <div class="col-sm-9">
      ...
      <input class="form-control" type="text" id="search_text" placeholder="Silahkan isi dengan nama kota" onkeypress="search_enter(event)">
