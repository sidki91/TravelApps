    ...
    else
    {
      ...
      $.ajax({
          ...
          data: {
              ...
              'kode_kapasitas'  : $("#kode_kapasitas").val(),
              'tipe_room'       : $("#tipe_room").val(),
              'id'              : $('#kode_room').val()
          ...
          success: function(data) {
            if(data.status=='error')
            {
              ...
              if (data.errors.tipe_room)
              {
                    alertMsg(data.errors.tipe_room,'error');
              }
              if (data.errors.kode_hotel)
              {
                    alertMsg(data.errors.kode_hotel,'error');
              }
              if (data.errors.kode_service)
              {
                    alertMsg(data.errors.kode_service,'error');
              }
              if (data.errors.kode_kapasitas)
              {
                    alertMsg(data.errors.kode_kapasitas,'error');
              }
