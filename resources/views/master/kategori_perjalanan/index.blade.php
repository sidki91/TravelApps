@extends('layouts.app')
@section('content')
@section('menu','Kategori Perjalanan')
          ...
          <div class="modal-body">
            ...
            <form class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="description" name="description" placeholder="isi dengan nama kategori perjalanan">
...
function list_data()
{
  ...
  $.ajax({
          type: "POST",
           url: 'kategori_perjalanan/list_data',
           data: {
...
$(document).on('click', '.add-data', function() {
  ...
  $('.modal-footer').on('click', '.add', function() {
    ...
    if(save_method == 'add')
    {
      url = "kategori_perjalanan";
    }
    else
    {
      url = "kategori_perjalanan/update";
    }
      $.ajax({
          type: 'POST',
          url : url,
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete)
          {
              $.ajax({
                  type: 'POST',
                  url: 'kategori_perjalanan/delete',
                  data: {
                      '_token': $('input[name=_token]').val(),
                      'id'    :id
