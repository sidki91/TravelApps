...
<p></p>
						<div class="form-inline">
						  <div class="form-group">
						   <div class="col-md-10">
              <input type="text" class="form-control" id="description_search" placeholder="Enter nama kota" onkeypress="search_enter(event)" style="width:450px">
						  </div>
            </div>
      ...
      $.ajax({
          ...
          success: function(data) {
            if(data.status=='error')
            {
                ...
                {
                      alertMsg(data.errors.kode_negara,'error');
                }
                if (data.errors.nama_kota)
                {
                      alertMsg(data.errors.nama_kota,'error');
                }
