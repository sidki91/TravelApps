          ...
          if (willDelete)
          {
              $.ajax({
                  ...
                  data: {
                      ...
                      'paket'               : paket,
                      'sub_paket'           : sub_paket,
                      'harga_paket_val'     : harga_paket_val,
                      'program_dipilih'     : program_dipilih,
                  ...
                  if(data.status=='error')
                  {
                      ...
                      if (data.errors.nomor_rumah)
                      {
                            alertMsg(data.errors.nomor_rumah,'error');
                      }
                      ...
                      if (data.errors.kode_pos)
                      {
                            alertMsg(data.errors.kode_pos,'error');
                      }
                      if (data.errors.telepon)
                      {
                            alertMsg(data.errors.telepon,'error');
                      }
                      ...
                      if (data.errors.program_dipilih)
                      {
                            alertMsg(data.errors.program_dipilih,'error');
                      }
                      if (data.errors.berangkat_dari)
                      {
                            alertMsg(data.errors.berangkat_dari,'error');
                      }
                      if (data.errors.penyakit_diderita)
                      {
                            alertMsg(data.errors.penyakit_diderita,'error');
                      }
                      if (data.errors.pengalaman_haji)
                      {
                            alertMsg(data.errors.pengalaman_haji,'error');
                      }
                      if (data.errors.pengalaman_umroh)
                      {
                            alertMsg(data.errors.pengalaman_umroh,'error');
                      }
