...
<html lang="en" dir="ltr">
  ...
  <?php
    $row = \App\Models\Formulir::with('user','get_provinsi','kabupaten_kota','get_kecamatan','get_kelurahan','get_pendidikan','get_kategori_perjalanan','get_paket_perjalanan')
                                ->where('kode_registrasi',$row_item->kode_registrasi)->first();
    $keluarga_dihubungi = \App\Models\KeluargaHubungi::where('kode_registrasi',$row_item->kode_registrasi)->get();
  ?>
    <div class="clear"></div>
